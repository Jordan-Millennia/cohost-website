const activeMarkets = [
  "Atlanta, GA", "Dallas, TX", "Houston, TX", "San Antonio, TX",
  "Charlotte, NC", "Nashville, TN", "Memphis, TN", "Birmingham, AL",
  "Jacksonville, FL", "Tampa, FL", "Orlando, FL", "Indianapolis, IN",
  "Columbus, OH", "Kansas City, MO", "St. Louis, MO", "Milwaukee, WI",
  "Phoenix, AZ", "Denver, CO",
];

const expandingMarkets = [
  "Austin, TX", "Raleigh, NC", "Richmond, VA",
  "Oklahoma City, OK", "Louisville, KY", "Tucson, AZ",
];
  ...
  return (
    <section id="markets" className="py-24 lg:py-32 bg-cream">
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div className="animate-in delay-200 mt-12 flex flex-wrap justify-center gap-3">
        ...
        <div className="animate-in delay-300 mt-8 flex items-center justify-center gap-8 text-xs text-charcoal/30">
