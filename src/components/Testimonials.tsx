      ...
      <div className="max-w-4xl mx-auto px-6 lg:px-8 text-center">
        ...
        <ScrollReveal delay={100}>
          <div className="mt-10 relative">
            <svg
              className="mx-auto w-14 h-14 text-brass/10 mb-4"
              viewBox="0 0 64 64"
              fill="currentColor"
            >
            ...
            <blockquote className="font-display text-2xl sm:text-3xl lg:text-4xl font-medium text-charcoal leading-[1.3] italic">
              &ldquo;We&rsquo;re building the case studies now. In the
              meantime, our numbers speak louder than testimonials ever
              could.&rdquo;
            </blockquote>
            <div className="mt-8">
        ...
        <ScrollReveal delay={200}>
          <a
            href="#contact"
            className="inline-flex items-center mt-10 text-sm font-semibold text-brass hover:text-brass-dark transition-colors gap-2"
          >
